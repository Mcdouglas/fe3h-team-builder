...
initJobs =
    ...
    -- DLC Classes
    , Job 47 47 "Trickster" 5 [ Proficiency Sword 2, Proficiency Faith 2 ] [ 6, 78 ] Nothing (Just CanUseSomeMagic) Nothing Nothing [] False
    , Job 48 48 "War Monk/Cleric" 5 [ Proficiency Brawling 2, Proficiency Faith 2 ] [ 55, 77 ] Nothing (Just CanUseSomeMagic) Nothing Nothing [] False
    , Job 49 49 "Dark Flier" 5 [ Proficiency Reason 2, Proficiency Flying 2 ] [ 67, 124 ] (Just Female) (Just CanUseMagic) Nothing Nothing [] True
    , Job 50 50 "Valkyrie" 5 [ Proficiency Reason 2, Proficiency Riding 2 ] [ 66, 114 ] (Just Female) (Just CanUseMagic) Nothing Nothing [] False
    , Job 51 51 "Death Knight" 5 [ Proficiency Lance 3, Proficiency Reason 2, Proficiency Riding 2 ] [] (Just Male) (Just CanUseMagic) (Just "Jeritza only") (Just 150) [ 39 ] False
    ]
