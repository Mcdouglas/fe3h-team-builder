...
initJobs =
    ...
    -- Intermediate
    , Job 6 3 "Lord" 2 [ Proficiency Sword 2, Proficiency Lance 1, Proficiency Authority 2 ] [ 3, 89 ] Nothing Nothing (Just "Edelgard, Dimitri and Claude only") Nothing
    ...
    , Job 40 0 "Enlightened One" 5 [ Proficiency Sword 3, Proficiency Brawling 2, Proficiency Faith 3, Proficiency Authority 3 ] [] Nothing (Just CanUseMagic) (Just "Byleth only") (Just 100)
    , Job 41 39 "Armored Lord" 5 [ Proficiency Axe 3, Proficiency Authority 3, Proficiency HeavyArmor 3 ] [] Nothing Nothing (Just "Edelgard only") (Just 150)
    , Job 42 40 "Emperor" 5 [ Proficiency Axe 3, Proficiency Authority 3, Proficiency HeavyArmor 3 ] [] Nothing Nothing (Just "Edelgard only") (Just 200)
    , Job 43 41 "High Lord" 5 [ Proficiency Sword 3, Proficiency Lance 3, Proficiency Authority 3 ] [] Nothing Nothing (Just "Dimitri only") (Just 150)
    , Job 44 42 "Great Lord" 5 [ Proficiency Sword 3, Proficiency Lance 3, Proficiency Authority 3 ] [] Nothing Nothing (Just "Dimitri only") (Just 200)
    , Job 45 43 "Wyvern Master" 5 [ Proficiency Bow 3, Proficiency Authority 3, Proficiency Flying 3 ] [] Nothing Nothing (Just "Claude only") (Just 150)
    , Job 46 44 "Barbarossa" 5 [ Proficiency Bow 3, Proficiency Authority 3, Proficiency Flying 3 ] [] Nothing Nothing (Just "Claude only") (Just 200)
    ]
