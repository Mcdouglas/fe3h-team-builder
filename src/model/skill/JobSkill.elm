...
initJobSkills =
    ...
    , JobSkill 1 151 "Canto" [ 9, 10, 21, 24, 31, 33, 34, 35, 37, 38, 45, 46, 49, 50, 51 ] False "After performing an action, user can use their leftover movement." Nothing Nothing Nothing Nothing Nothing Nothing
    ...
    , JobSkill 7 142 "Locktouch" [ 8, 20, 47 ] False "Unit can open locks and chests without keys." Nothing Nothing Nothing Nothing Nothing Nothing
    ...
    , JobSkill 11 145 "Heal" [ 17, 48 ] False "Unit can use Heal. If it has already been learnt, the number of times it can be used is doubled." Nothing Nothing Nothing Nothing Nothing Nothing
    ...
    , JobSkill 16 75 "Lancefaire" [ 21, 31, 34, 43, 44, 51 ] False "Might +5 when a lance is equipped." Nothing Nothing Nothing Nothing Nothing Nothing
    , JobSkill 17 76 "Bowfaire" [ 25, 35, 45, 46 ] False "Might +5 when a bow is equipped." Nothing Nothing Nothing Nothing Nothing Nothing
    , JobSkill 18 77 "Fistfaire" [ 26, 32, 48 ] False "Might +5 when a gauntlet is equipped." Nothing Nothing Nothing Nothing Nothing Nothing
    , JobSkill 19 78 "Black Tomefaire" [ 27, 30, 37, 49 ] False "Might +5 when Black Magic is equipped." Nothing Nothing Nothing Nothing Nothing Nothing
    , JobSkill 20 79 "Dark Tomefaire" [ 37, 49 ] False "Might +5 when Dark Magic is equipped." Nothing Nothing Nothing Nothing Nothing Nothing
    ...
    , JobSkill 29 182 "Stealth" [ 8, 20, 47 ] False "Unit is less likely to be targeted by enemies." Nothing Nothing Nothing Nothing Nothing Nothing
    ...
    , JobSkill 33 92 "Black Magic Range +1" [ 50 ] False "Increases black magic range by 1." Nothing Nothing Nothing Nothing Nothing Nothing
    , JobSkill 34 93 "Dark Magic Range +1" [ 50 ] False "Increases dark magic range by 1." Nothing Nothing Nothing Nothing Nothing Nothing
    ]
