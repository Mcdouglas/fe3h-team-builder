...
var $author$project$UrlDecoder$decodeUrlInSkill = function (segment) {
	var skillType = function () {
		var _v0 = A3($elm$core$String$slice, 0, 1, segment);
		switch (_v0) {
			case 'm':
...
var $author$project$CustomTypes$Special = {$: 'Special'};
...
var $author$project$JobCategory$initJobCategories = _List_fromArray(
	[
		...
		$author$project$CustomTypes$JobCategory,
		5,
		$author$project$CustomTypes$Special,
		$elm$core$Maybe$Just(150),
		$elm$core$Maybe$Just(20))
	]);
...
var $author$project$JobSkill$initJobSkills = _List_fromArray(
	[
		...
		_List_fromArray(
			[9, 10, 21, 24, 31, 33, 34, 35, 37, 38, 45, 46, 49, 50, 51]))(false)('After performing an action, user can use their leftover movement.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		...
		_List_fromArray(
			[8, 20, 47]))(false)('Unit can open locks and chests without keys.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		...
		_List_fromArray(
			[17, 48]))(false)('Unit can use Heal. If it has already been learnt, the number of times it can be used is doubled.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		...
		_List_fromArray(
			[21, 31, 34, 43, 44, 51]))(false)('Might +5 when a lance is equipped.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		...
		_List_fromArray(
			[26, 32, 48]))(false)('Might +5 when a gauntlet is equipped.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$JobSkill(19)(78)('Black Tomefaire')(
		_List_fromArray(
			[27, 30, 37, 49]))(false)('Might +5 when Black Magic is equipped.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$JobSkill(20)(79)('Dark Tomefaire')(
		_List_fromArray(
			[37, 49]))(false)('Might +5 when Dark Magic is equipped.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		...
		_List_fromArray(
			[8, 20, 47]))(false)('Unit is less likely to be targeted by enemies.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		...
		$author$project$CustomTypes$JobSkill(33)(92)('Black Magic Range +1')(
		_List_fromArray(
			[50]))(false)('Increases black magic range by 1.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$JobSkill(34)(93)('Dark Magic Range +1')(
		_List_fromArray(
			[50]))(false)('Increases dark magic range by 1.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)
	]);
...
var $author$project$Job$initJobs = _List_fromArray(
	[
		...
		$elm$core$Maybe$Just($author$project$CustomTypes$CanUseMagic))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(_List_Nil)(false),
		$author$project$CustomTypes$Job(47)(47)('Trickster')(5)(
		_List_fromArray(
			[
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Sword, 2),
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Faith, 2)
		...
		_List_fromArray(
			[6, 78]))($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just($author$project$CustomTypes$CanUseSomeMagic))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(_List_Nil)(false),
		$author$project$CustomTypes$Job(48)(48)('War Monk/Cleric')(5)(
		_List_fromArray(
			[
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Brawling, 2),
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Faith, 2)
		...
		_List_fromArray(
			[55, 77]))($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just($author$project$CustomTypes$CanUseSomeMagic))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(_List_Nil)(false),
		$author$project$CustomTypes$Job(49)(49)('Dark Flier')(5)(
		_List_fromArray(
			[
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Reason, 2),
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Flying, 2)
		...
		_List_fromArray(
			[67, 124]))(
		$elm$core$Maybe$Just($author$project$CustomTypes$Female))(
		$elm$core$Maybe$Just($author$project$CustomTypes$CanUseMagic))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(_List_Nil)(true),
		$author$project$CustomTypes$Job(50)(50)('Valkyrie')(5)(
		_List_fromArray(
			[
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Reason, 2),
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Riding, 2)
		...
		$elm$core$Maybe$Just($author$project$CustomTypes$Female))(
		$elm$core$Maybe$Just($author$project$CustomTypes$CanUseMagic))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(_List_Nil)(false),
		$author$project$CustomTypes$Job(51)(51)('Death Knight')(5)(
		_List_fromArray(
			[
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Lance, 3),
				A2($author$project$CustomTypes$Proficiency, $author$project$CustomTypes$Reason, 2),
		...
		$elm$core$Maybe$Just($author$project$CustomTypes$Male))(
		$elm$core$Maybe$Just($author$project$CustomTypes$CanUseMagic))(
		$elm$core$Maybe$Just('Jeritza only'))(
		$elm$core$Maybe$Just(150))(
		_List_fromArray(
			[39]))(false)
	]);
...
var $author$project$MasterySkill$initMasterySkills = _List_fromArray(
	[
		...
		$elm$core$Maybe$Just(
			_Utils_Tuple2(1, 1))),
		$author$project$CustomTypes$MasterySkill(54)(110)('Duelist\'s Blow')(
		_List_fromArray(
			[47]))(false)('If unit initiates combat, grants Avo +20 during combat.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$MasterySkill(55)(110)('Brawl Avo +20')(
		_List_fromArray(
			[48]))(false)('Grants Avo +20 when brawling.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$MasterySkill(56)(109)('Transmute')(
		_List_fromArray(
			[49]))(false)('If unit is hit by a magic attack during enemy phase, grants +3 to all stats until next player phase ends.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$MasterySkill(57)(170)('Uncanny Blow')(
		_List_fromArray(
			[50]))(false)('If unit initiates combat, grants Hit +30 during combat.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$MasterySkill(58)(158)('Counterattack')(
		_List_fromArray(
			[51]))(false)('Allows unit to counterattack regardless of distance to attacker.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$MasterySkill(59)(191)('Foul Play')(
		_List_fromArray(
			[47]))(true)('User swaps places with an ally within 5 spaces.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just(
			_Utils_Tuple2(1, 5))),
		$author$project$CustomTypes$MasterySkill(60)(190)('Pneuma Gale')(
		_List_fromArray(
			[48]))(true)('Deals magic-based damage.')(
		$elm$core$Maybe$Just(4))(
		$elm$core$Maybe$Just(5))(
		$elm$core$Maybe$Just(10))($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just(10))(
...
var $author$project$StandardSkill$initStandardSkills = _List_fromArray(
	[
		...
		_List_fromArray(
			[22, 23]))(false)('Deals magic-based damage, Might increases based on user\'s Resistance.')(
		$elm$core$Maybe$Just(4))(
		$elm$core$Maybe$Just(2))(
		$elm$core$Maybe$Just(10))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just(
		...
		_List_fromArray(
			[4, 13, 24, 31]))(false)('After combat, inflicts Def -5 on foe for 1 turn.')(
		$elm$core$Maybe$Just(3))(
		$elm$core$Maybe$Just(4))(
		$elm$core$Maybe$Just(10))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just(
		...
		_List_fromArray(
			[3, 19, 23]))(false)('Deals magic-based damage. Might increases based on user’s Dexterity.')(
		$elm$core$Maybe$Just(4))(
		$elm$core$Maybe$Just(3))(
		...
		_List_fromArray(
			[6, 32, 38]))(false)('Depletes all of the weapon’s remaining durability and adds 30% of that value to Might.')(
		$elm$core$Maybe$Just(1))(
		$elm$core$Maybe$Just(3))(
		$elm$core$Maybe$Just(10))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just(
		...
		_List_fromArray(
			[9, 15]))(false)('After combat, inflicts Str -5 on foe for 1 turn.')(
		$elm$core$Maybe$Just(3))(
		$elm$core$Maybe$Just(4))(
		$elm$core$Maybe$Just(10))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just(
		...
		_List_fromArray(
			[0, 1, 12, 37]))(false)('Deals magic-based damage.')(
		$elm$core$Maybe$Just(3))(
		$elm$core$Maybe$Just(10))(
		$elm$core$Maybe$Just(10))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(
		$elm$core$Maybe$Just(
		...
		$elm$core$Maybe$Just(
			_Utils_Tuple2(1, 1))),
		$author$project$CustomTypes$StandardSkill(200)(200)('Black Magic Crit +10')(60)(false)(
		_List_fromArray(
			[2, 12, 36]))(false)('Grants Crit +10 when using Black Magic.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$StandardSkill(201)(201)('Seal Speed')(96)(false)(
		_List_fromArray(
			[4, 24]))(false)('If unit damages foe during combat, foe suffers Spd -6 for 1 turn after combat.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$StandardSkill(202)(202)('Pass')(108)(false)(
		_List_fromArray(
			[7, 40]))(false)('Unit can pass through foes.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$StandardSkill(203)(203)('White Magic Avoid +20')(72)(false)(
		_List_fromArray(
			[0, 1, 8]))(false)('Grants Avo +20 when equipped with White Magic.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$StandardSkill(204)(204)('Seal Movement')(108)(false)(
		_List_fromArray(
			[10]))(false)('If unit damages foe during combat, foe suffers Mv -1 for 1 turn after combat.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$StandardSkill(205)(205)('Black Magic Avoid +20')(60)(false)(
		_List_fromArray(
			[14]))(false)('Grants Avo +20 when equipped with Black Magic.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$StandardSkill(206)(206)('Seal Strength')(60)(false)(
		_List_fromArray(
			[21]))(false)('If unit damages foe during combat, foe suffers Str -6 for 1 turn after combat.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$StandardSkill(207)(207)('Seal Magic')(60)(false)(
		_List_fromArray(
			[27]))(false)('If unit damages foe during combat, foe suffers Mag -6 for 1 turn after combat.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$author$project$CustomTypes$StandardSkill(208)(208)('Darting Blow')(120)(false)(
		_List_fromArray(
			[39]))(false)('If unit initiates combat, grants AS +6 during combat.')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)
	]);
...
var $author$project$GlobalMessage$FileSelected = function (a) {
	return {$: 'FileSelected', a: a};
};
var $author$project$GlobalMessage$RewriteUrl = {$: 'RewriteUrl'};
var $author$project$GlobalMessage$TeamFileRead = function (a) {
	return {$: 'TeamFileRead', a: a};
};
...
var $author$project$SkillEventListener$updateSkillAndKeepOther = F3(
	function (_v0, skillIdx, skill) {
		var idx = _v0.a;
		var oldSkillId = _v0.b;
		var skillType = _v0.c;
...
var $author$project$SkillEventListener$updateSkillInBuild = F2(
	function (maybeBuild, _v0) {
		var _v1 = _v0.a;
		var skillIdx = _v1.b;
		var skill = _v0.b;
		var isCombatArt = _v0.c;
		return A2(
			$elm$core$Maybe$andThen,
			function (build) {
				if (isCombatArt) {
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 'SaveTeam':
					var teamJson = '{\"team\": \"' + ($author$project$UrlDecoder$encodeTeamInUrl(model) + '\"}');
					return _Utils_Tuple2(
						model,
						A3($elm$file$File$Download$string, 'fe3h_team.json', 'application/json', teamJson));
				case 'LoadTeamRequest':
					return _Utils_Tuple2(
						model,
						A2(
							...
							_List_fromArray(
								['application/json']),
							$author$project$GlobalMessage$FileSelected));
				case 'FileSelected':
					var file = msg.a;
					return _Utils_Tuple2(
						model,
						A2(
							$elm$core$Task$perform,
							$author$project$GlobalMessage$TeamFileRead,
				...
				case 'TeamFileRead':
					...
					var url = A3(
						...
						'\"}',
						'',
						A3($elm$core$String$replace, '{\"team\": \"', '', content));
					var $temp$msg = $author$project$GlobalMessage$RewriteUrl,
						$temp$model = _Utils_update(
						model,
						{
							team: $author$project$UrlDecoder$decodeUrlInTeam(url)
						});
					msg = $temp$msg;
					model = $temp$model;
					continue update;
...
var $author$project$Study$initAcademicSkillsList = A3(
	...
	A3(
		...
		_List_fromArray(
			[$author$project$CustomTypes$Reason, $author$project$CustomTypes$Authority]),
		A3(
			$author$project$Study$setupAcademicSkills,
			...
			A3(
				...
				_List_fromArray(
					[$author$project$CustomTypes$Sword, $author$project$CustomTypes$Axe, $author$project$CustomTypes$Bow, $author$project$CustomTypes$Faith]),
		...
		A3(
			...
			A3(
				...
				A3(
					...
					$author$project$CustomTypes$Strength,
					_List_fromArray(
						[$author$project$CustomTypes$Sword, $author$project$CustomTypes$Lance, $author$project$CustomTypes$Brawling, $author$project$CustomTypes$Riding]),
					$author$project$Study$defaultAcademicSkills))),
		A3(
			$elm$core$Dict$insert,
			38,
			A3(
				...
				$author$project$CustomTypes$Weakness,
				_List_fromArray(
					[$author$project$CustomTypes$Brawling, $author$project$CustomTypes$Authority, $author$project$CustomTypes$HeavyArmor]),
				A3(
					$author$project$Study$setupAcademicSkills,
					$author$project$CustomTypes$BuddingTalent,
					_List_fromArray(
					...
					A3(
						...
						$author$project$CustomTypes$Strength,
						_List_fromArray(
							[$author$project$CustomTypes$Reason, $author$project$CustomTypes$Riding, $author$project$CustomTypes$Flying]),
						$author$project$Study$defaultAcademicSkills))),
			A3(
				$elm$core$Dict$insert,
				37,
				A3(
					...
					$author$project$CustomTypes$Weakness,
					_List_fromArray(
						[$author$project$CustomTypes$Axe, $author$project$CustomTypes$HeavyArmor]),
					A3(
						$author$project$Study$setupAcademicSkills,
						$author$project$CustomTypes$BuddingTalent,
						_List_fromArray(
						...
						A3(
							...
							$author$project$CustomTypes$Strength,
							_List_fromArray(
								[$author$project$CustomTypes$Sword, $author$project$CustomTypes$Reason, $author$project$CustomTypes$Flying]),
							$author$project$Study$defaultAcademicSkills))),
				A3(
					$elm$core$Dict$insert,
					36,
					A3(
						...
						$author$project$CustomTypes$Weakness,
						_List_fromArray(
							[$author$project$CustomTypes$Lance, $author$project$CustomTypes$Bow, $author$project$CustomTypes$Flying]),
						A3(
							$author$project$Study$setupAcademicSkills,
							$author$project$CustomTypes$BuddingTalent,
							_List_fromArray(
							...
							A3(
								...
								$author$project$CustomTypes$Strength,
								_List_fromArray(
									[$author$project$CustomTypes$Sword, $author$project$CustomTypes$Axe, $author$project$CustomTypes$Brawling, $author$project$CustomTypes$Faith]),
								$author$project$Study$defaultAcademicSkills))),
					A3(
						$elm$core$Dict$insert,
						35,
						A3(
							...
							$author$project$CustomTypes$Weakness,
							_List_fromArray(
								[$author$project$CustomTypes$Lance, $author$project$CustomTypes$Axe, $author$project$CustomTypes$Riding, $author$project$CustomTypes$Flying]),
							A3(
								$author$project$Study$setupAcademicSkills,
								$author$project$CustomTypes$BuddingTalent,
								_List_fromArray(
								...
								A3(
									...
									$author$project$CustomTypes$Strength,
									_List_fromArray(
										[$author$project$CustomTypes$Sword, $author$project$CustomTypes$Reason, $author$project$CustomTypes$Faith, $author$project$CustomTypes$Authority]),
									$author$project$Study$defaultAcademicSkills))),
						A3(
							$elm$core$Dict$insert,
							34,
				...
				_List_fromArray(
					[
						...
						A2(
							...
							function (_v1) {
								var k = _v1.a;
								return $author$project$StudyView$getStudyPicture(
									$author$project$Study$subjectToId(
						...
						A2(
							...
							function (_v3) {
								var v = _v3.b;
								return $author$project$StudyView$getAcademicSkill(v);
							},
							A2(
								$elm$core$List$sortBy,
								function (_v2) {
...
var $author$project$Crest$initCrests = _List_fromArray(
	[
		...
		A4($author$project$CustomTypes$Crest, 18, 18, 'Aubin', 'Occasionally prevents enemy counterattacks when using a weapon.'),
		A4($author$project$CustomTypes$Crest, 19, 19, 'Chevalier', 'Sometimes restores HP equal to 30% of damage dealt when using combat arts.'),
		A4($author$project$CustomTypes$Crest, 20, 20, 'Noa', 'Occasionally does not consume a use for attack magic.'),
		A4($author$project$CustomTypes$Crest, 21, 21, 'Timandant', 'Occasionally does not consume a use for recovery magic.'),
		A4($author$project$CustomTypes$Crest, 22, 22, 'Ernest', 'Occasionally prevents enemy counterattacks when using a weapon.')
	]);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				function () {
				var _v0 = $author$project$Crest$getCrest(crestId);
				if (_v0.$ === 'Just') {
					var value = _v0.a;
					return A2(
						$elm$html$Html$div,
...
var $author$project$CharacterSkill$initCharacterSkills = _List_fromArray(
	[
		...
		A4($author$project$CustomTypes$CharacterSkill, 38, 132, 'Honorable Spirit', 'If unit is not adjacent to an ally, grants Attack +3 when in combat with a foe 1 space away.'),
		A4($author$project$CustomTypes$CharacterSkill, 39, 124, 'King of Grappling', 'Grants Strength/Defense +6 when HP is ≤ 50%.'),
		A4($author$project$CustomTypes$CharacterSkill, 40, 138, 'Circadian Beat', 'Grants Strength/Magic +3 when indoors, and Defense/Resistance +3 when outdoors.'),
		A4($author$project$CustomTypes$CharacterSkill, 41, 120, 'Monstrous Appeal', 'Makes all attacks effective against monsters and makes it easier for monsters to target unit.'),
		A4($author$project$CustomTypes$CharacterSkill, 42, 165, 'Murderous Intent', 'If unit initiates combat, grants Hit +20 during combat.'),
		A4($author$project$CustomTypes$CharacterSkill, 43, 149, 'Business Prosperity', 'Grants Luck +5.')
	]);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				function () {
				var _v0 = $author$project$CharacterSkill$getCharacterSkillById(skillId);
				if (_v0.$ === 'Just') {
					var value = _v0.a;
					return A2(
						$elm$html$Html$div,
...
var $author$project$CharacterModal$modalCharacterPicker = function (model) {
	var _v0 = model.view.characterPicker;
	var idx = _v0.a;
	var maybeCharacter = _v0.b;
...
var $author$project$JobModal$viewJobsGrid = function (model) {
	var rowDiv = function () {
		var _v0 = model.view.categorySelected;
		if (_v0.$ === 'Just') {
...
var $author$project$SkillModal$viewSkillTile = F2(
	function (model, skill) {
		var _v0 = model.view.skillPicker;
		var _v1 = _v0.a;
		var buildIdx = _v1.a;
		var skillIdx = _v1.b;
		var isCombatArt = _v0.c;
...
var $author$project$SkillModal$viewCombatArtDescription = function (skill) {
	var rangeInString = function (_v0) {
		var start = _v0.a;
		var end = _v0.b;
...
var $author$project$GlobalMessage$LoadTeamRequest = {$: 'LoadTeamRequest'};
var $author$project$GlobalMessage$SaveTeam = {$: 'SaveTeam'};
var $elm$html$Html$button = _VirtualDom_node('button');
var $author$project$TeamBuilder$viewSaveLoad = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onClick($author$project$GlobalMessage$SaveTeam)
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onClick($author$project$GlobalMessage$LoadTeamRequest)
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Charger')
				]))
		]));
...
var $author$project$SkillView$skillButton = function (_v0) {
	var positions = _v0.a;
	var maybeSkill = _v0.b;
	var isCombatArt = _v0.c;
...
var $author$project$BuildView$sectionActiveSkills = function (_v0) {
	var buildIdx = _v0.a;
	var build = _v0.b;
...
var $author$project$BuildView$sectionJob = function (_v0) {
	var buildIdx = _v0.a;
	var build = _v0.b;
...
var $author$project$BuildView$sectionPassiveSkills = function (_v0) {
	var buildIdx = _v0.a;
	var build = _v0.b;
...
var $author$project$BuildView$viewBuild = function (_v0) {
	var idx = _v0.a;
	var build = _v0.b;
...
var $author$project$TeamBuilder$viewTeam = function (model) {
	var addBuildButton = ($elm$core$Dict$size(model.team) < 15) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$TeamBuilder$viewSaveLoad
					])),
